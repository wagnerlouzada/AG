...
//        public string[] Provider { get; set; } = { "System.Data.SqlClient","System.Data.Odbc","System.Data.OleDb" };
...
//            else
//            {
//                dbQuery = new Database(ConnectionString, Provider[0]);
//            }
...
//        {
//            string table = Table;
//            string UpdateStatement = "Update " + Table + " \nSet \n" + UpdateStr() + "\n Where " + pkfield.ToString() + " = " + PkValue.ToString();
...
//                                                ", Table, PkValue.ToString(), PkField);
...
//                                        $"begin " +
//                                            $"insert into {Table} ({ PkField}) Values ({ keyValue}); " +
//                                            $"Select CAST(scope_identity() AS bigint); " +
//                                        $"end " +
...
//        /// <returns></returns>
//        public IEnumerable<T> Query<T>(Database db, String cmd, Dictionary<String, Object> parametros = null)
//        {
//            db.CommandText = cmd;
...
//                            propInfo.SetValue(rec, isDBNull(dr.GetValue(i)));
//                        }
//                    }
//                    result.Add(rec);
//                }
